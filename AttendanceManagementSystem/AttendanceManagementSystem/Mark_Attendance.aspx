<%@ Page Title="" Language="C#" MasterPageFile="~/TeacherMaster.Master" AutoEventWireup="true" CodeBehind="Mark_Attendance.aspx.cs" Inherits="AttendanceManagementSystem.Mark_Attendance" %>
    ...
    <center>
        <table align="center" style="width: 1200px; height: 366px">
            <tr style="width: 1200px;">
                ...
                <td>
                    <asp:DropDownList ID="DropDownList5" runat="server" Height="40px" Width="125px" AutoPostBack="true" OnSelectedIndexChanged="DropDownList5_SelectedIndexChanged1">
